...
class XmlSerializer(Serializer):
    ...
    def serialize_attrib(self, op):
        """
        Serializer for :meth:`py_bpmn_engine.operators.Attrib`.
    ...
    def serialize_pathattrib(self, op):
        """
        Serializer for :meth:`py_bpmn_engine.operators.PathAttrib`.
    ...
    def serialize_assign(self, op):
        """
        Serializer for :meth:`py_bpmn_engine.operators.Assign`.
    ...
    def serialize_operator_equal(self, op):
        """
        Serializer for :meth:`py_bpmn_engine.operators.Equal`.
    ...
    def serialize_operator_not_equal(self, op):
        """
        Serializer for :meth:`py_bpmn_engine.operators.NotEqual`.
    ...
    def serialize_task_spec(self, spec, elem):
        """
        Serializes common attributes of :meth:`py_bpmn_engine.specs.TaskSpec`.
        """
    ...
    def serialize_acquire_mutex(self, spec):
        """
        Serializer for :meth:`py_bpmn_engine.specs.AcquireMutex`.
        """
