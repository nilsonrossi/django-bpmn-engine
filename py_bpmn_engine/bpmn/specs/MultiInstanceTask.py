...
from py_bpmn_engine.bpmn.exceptions import WorkflowTaskExecException
...
class MultiInstanceTask(TaskSpec):
    ...
    def __init__(self, wf_spec, name, times, **kwargs):
        ...
        :type  times: int or :class:`py_bpmn_engine.operators.Term`
        :param times: The number of tasks to create.
        :type  kwargs: dict
        :param kwargs: See :class:`py_bpmn_engine.specs.TaskSpec`.
        """
        if times is None:
