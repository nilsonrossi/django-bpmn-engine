...
from .task_spec_converters import BoundaryEventConverter
from .task_spec_converters import BoundaryEventParentConverter
from .task_spec_converters import CallActivityTaskConverter
from .task_spec_converters import EndEventConverter
from .task_spec_converters import EndJoinConverter
from .task_spec_converters import ExclusiveGatewayConverter
from .task_spec_converters import InclusiveGatewayConverter
from .task_spec_converters import IntermediateCatchEventConverter
from .task_spec_converters import IntermediateThrowEventConverter
from .task_spec_converters import LoopResetTaskConverter
from .task_spec_converters import ManualTaskConverter
from .task_spec_converters import NoneTaskConverter
from .task_spec_converters import ParallelGatewayConverter
from .task_spec_converters import ScriptTaskConverter
from .task_spec_converters import SimpleTaskConverter
from .task_spec_converters import StartEventConverter
from .task_spec_converters import StartTaskConverter
from .task_spec_converters import TransactionSubprocessTaskConverter
...
class BpmnWorkflowSerializer:
    ...
    def configure_workflow_spec_converter(task_spec_overrides=None, data_converter=None, version=VERSION):
        ...
        for klass in DEFAULT_TASK_SPEC_CONVERTER_CLASSES:
            if klass.__name__ not in classnames:
                converters.append(klass(data_converter=data_converter))
